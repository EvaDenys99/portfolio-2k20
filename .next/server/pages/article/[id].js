...
const Article = ({
  ...
  return __jsx(_components_layout__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"], null, __jsx("div", {
  ...
  }), article.images && article.images[1] && __jsx(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, __jsx("img", {
  ...
  }, article.images && article.images.map((m, i) => __jsx("div", {
    key: i,
    ...
    className: "jsx-3703438055"
  }, m.caption)))), article.videos && article.videos.map((m, i) => __jsx("div", {
    key: i,
    className: "jsx-3703438055" + " " + "pb-2"
  }, __jsx("video", {
    controls: true,
