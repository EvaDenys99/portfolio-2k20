...
const Article = ({
  ...
  if (router.isFallback) {
    ...
    className: "jsx-3785666734" + " " + "container animate__animated animate__fadeIn"
    ...
    className: "jsx-3785666734"
  }, __jsx("ol", {
    className: "jsx-3785666734" + " " + "breadcrumb small pt-4"
  }, __jsx("li", {
    className: "jsx-3785666734" + " " + "breadcrumb-item active"
  }, __jsx("a", {
    href: "/blog",
    className: "jsx-3785666734"
  }, "Blogposts")), __jsx("li", {
    "aria-current": "page",
    className: "jsx-3785666734" + " " + "breadcrumb-item"
  }, ">_", article.title))), __jsx("div", {
    className: "jsx-3785666734" + " " + "animate__animated animate__fadeIn animate__slow"
  }, __jsx("img", {
    src: true ? article.headImage.url : undefined,
    alt: article.headImage.url,
    height: "200",
    className: "jsx-3785666734" + " " + "img-fluid border border-info mb-3"
  }), __jsx("div", {
    className: "jsx-3785666734" + " " + "d-flex flex-row justify-content-between"
  }, __jsx("h1", {
    className: "jsx-3785666734"
  }, article.title), __jsx("div", {
    className: "jsx-3785666734"
  }, __jsx("p", {
    className: "jsx-3785666734" + " " + "small text-muted text-right"
  }, "By ", article.createdBy), __jsx("p", {
    className: "jsx-3785666734" + " " + "small text-muted text-right"
  }, article.creationdate))), __jsx("div", {
    className: "jsx-3785666734" + " " + "d-flex flex-row pb-2"
  }, article.categories.map((c, i) => __jsx("p", {
    key: i,
    className: "jsx-3785666734" + " " + "small pr-1 text-muted"
  }, "#", c.name))), __jsx(react_markdown__WEBPACK_IMPORTED_MODULE_4___default.a, {
    className: "line-break",
    source: article.description
  }), article.images.length > 1 && __jsx(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, __jsx("img", {
    src: true ? article.images[0].url : undefined,
    alt: article.images[0].url,
    height: "200",
    className: "jsx-3785666734" + " " + "img-fluid mt-4"
  }), __jsx("p", {
    className: "jsx-3785666734" + " " + "small text-muted"
  }, __jsx("em", {
    className: "jsx-3785666734"
    ...
    className: "jsx-3785666734" + " " + "mt-4 row row-cols-1 row-cols-md-2"
  }, article.images.length > 0 && article.images.map((m, i) => __jsx("div", {
    key: i,
    className: "jsx-3785666734" + " " + "pb-2"
  }, __jsx("img", {
    src: true ? m.url : undefined,
    alt: true ? m.url : undefined,
    className: "jsx-3785666734" + " " + "mb-2 pl-1 img-fluid"
  }), __jsx("p", {
    className: "jsx-3785666734" + " " + "small text-muted"
  }, __jsx("em", {
    className: "jsx-3785666734"
  }, m.caption)))), article.videos.length > 0 && article.videos.map((m, i) => __jsx("div", {
    key: i,
    className: "jsx-3785666734" + " " + "pb-2"
  }, __jsx("video", {
    autoplay: true,
