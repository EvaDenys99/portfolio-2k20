...
const Project = ({
  ...
  const imageUrl = true ? project.headImage.url : undefined;
  return __jsx(_components_layout__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"], null, __jsx("div", {
    ...
    className: "jsx-3603070660" + " " + "breadcrumb small pt-4"
  }, __jsx("li", {
    className: "jsx-3603070660" + " " + "breadcrumb-item active"
  }, __jsx("a", {
    href: "/projects",
    className: "jsx-3603070660"
  }, "Projects")), __jsx("li", {
    "aria-current": "page",
    className: "jsx-3603070660" + " " + "breadcrumb-item"
  }, ">_", project.title))), __jsx("div", {
    className: "jsx-3603070660" + " " + "animate__animated animate__fadeIn animate__slow"
  }, __jsx("img", {
    src: imageUrl,
    alt: project.headImage.url,
    height: "200",
    className: "jsx-3603070660" + " " + "img-fluid border border-secondary mb-3"
  }), __jsx("div", {
    className: "jsx-3603070660" + " " + "d-flex flex-row justify-content-between"
  }, __jsx("h1", {
    className: "jsx-3603070660"
  }, project.title), __jsx("p", {
    className: "jsx-3603070660" + " " + "small text-muted text-right align-self-center"
  }, project.creationDate)), __jsx("div", {
    className: "jsx-3603070660" + " " + "d-flex flex-row pb-2"
  }, project.categories.map((c, i) => __jsx("p", {
    key: i,
    className: "jsx-3603070660" + " " + "small pr-1 text-muted"
  }, "#", c.name))), __jsx(react_markdown__WEBPACK_IMPORTED_MODULE_4___default.a, {
    source: project.bio
  }), project.link && __jsx("p", {
    className: "jsx-3603070660" + " " + "mt-2 "
  }, __jsx("em", {
    className: "jsx-3603070660"
    ...
    className: "jsx-3603070660" + " " + "highlights"
  }, "here"), "."))), __jsx("div", {
    className: "jsx-3603070660" + " " + "mt-4"
  }, __jsx("h2", {
    className: "jsx-3603070660"
  }, "> team"), __jsx("p", {
    className: "jsx-3603070660"
  }, project.team)), __jsx("div", {
    className: "jsx-3603070660" + " " + "mt-4"
  }, __jsx("h2", {
    className: "jsx-3603070660"
  }, "> tools"), __jsx("p", {
    className: "jsx-3603070660"
  }, project.tools)), __jsx("img", {
    src: true ? project.images[0].url : undefined,
    alt: project.images[0].url,
    height: "200",
    className: "jsx-3603070660" + " " + "img-fluid mt-4"
  }), __jsx("p", {
    className: "jsx-3603070660" + " " + "small text-muted"
  }, __jsx("em", {
    className: "jsx-3603070660"
    ...
    className: "jsx-3603070660" + " " + "mt-4 row row-cols-1 row-cols-md-2"
  }, project.vids.map((m, i) => __jsx("div", {
    key: i,
    className: "jsx-3603070660" + " " + "pb-2"
  }, __jsx("video", {
    controls: true,
    className: "jsx-3603070660" + " " + "mb-2 pl-1 img-fluid"
  }, __jsx("source", {
    ...
    className: "jsx-3603070660"
  }, m.caption)))), project.images.map((m, i) => __jsx("div", {
    key: i,
    className: "jsx-3603070660" + " " + "pb-2"
  }, __jsx("img", {
    src: true ? m.url : undefined,
